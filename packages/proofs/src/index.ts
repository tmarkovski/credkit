 ...
 * equality across hidden messages (the link-secret mechanic). No spec, no fixtures — this
 * package's wire format and transcript are bespoke and pinned by its own golden-vector tests.
 *
