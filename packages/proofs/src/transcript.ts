...
// way. V4: accumulator-membership predicates (revocation, FINDINGS §18) joined the same
// way. No earlier version shipped outside this repo, but the golden-vector rule is
// absolute — layout changes bump the version, they don't edit hex.
export const PROTOCOL_ID = "CREDKIT-PROOFS-V4";
